...
struct qt_meta_stringdata_CLASSVideoListModelENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSVideoListModelENDCLASS = QtMocHelpers::stringData(
    "VideoListModel",
    "addVideo",
    "",
    "filePath"
...
Q_CONSTINIT static const uint qt_meta_data_CLASSVideoListModelENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject VideoListModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSVideoListModelENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSVideoListModelENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSVideoListModelENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void VideoListModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->addVideo((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
}
...
void *VideoListModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSVideoListModelENDCLASS.stringdata0))
