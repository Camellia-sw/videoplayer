...
Registry::Registry() {
    resourcePathToCachedUnit.insert(QStringLiteral("/video/Main.qml"), &QmlCacheGeneratedCode::_video_Main_qml::unit);
    resourcePathToCachedUnit.insert(QStringLiteral("/video/Footer.qml"), &QmlCacheGeneratedCode::_video_Footer_qml::unit);
...
int QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appvideo)() {
    ::unitRegistry();
    return 1;
}
Q_CONSTRUCTOR_FUNCTION(QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appvideo))
int QT_MANGLE_NAMESPACE(qCleanupResources_qmlcache_appvideo)() {
    return 1;
}
